...
import com.liferay.portlet.sample.arquillian.NoSuchFooException;
import com.liferay.portlet.sample.arquillian.model.Foo;
import com.liferay.portlet.sample.arquillian.model.impl.FooImpl;
import com.liferay.portlet.sample.arquillian.model.impl.FooModelImpl;
...
public class FooPersistenceImpl extends BasePersistenceImpl<Foo>
	...
	@Override
	public Foo updateImpl(com.liferay.portlet.sample.arquillian.model.Foo foo)
		throws SystemException {
		foo = toUnwrappedModel(foo);
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.liferay.portlet.sample.arquillian.model.Foo")));
